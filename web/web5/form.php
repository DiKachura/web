...
<body>
  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <br>
      Год рождения:<br>
      <select id="year" size="3" name="year" <?php if ($errors['year']) {print 'class="group error"';} else print 'class="group"';?> value="<?php print $values['year']; ?>">
  ...
  <div class="container">
    <?php
      if (!empty($_COOKIE[session_name()]) && !empty($_SESSION['login']))
        print('<a href="./?quit=1" class = "enter-exit" title = "Log in">Выйти</a>');
      else
        print('<a href="login.php" class = "enter-exit"  title = "Log out">Войти</a>');
    ?>
  </div>
</body>
</html>